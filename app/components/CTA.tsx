    ...
    return (
        <div className="flex mt-5">
            <button
                ...
                tabIndex={-1}
                onClick={onRestart}
                className="text-white bg-sky-600 hover:bg-sky-500 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800"
            >
                <FiRotateCcw />
